...
//const { join } = require('path'); // this should bring in the join method from the path package
...
//so i fixed the pathing issue but now the problem is that it cannot find the file/directory for "Error: ENOENT: no such file or directory, open 'C:\Users\Exotic_23\Documents\svg-gen-cli\lib\logos\square-123.svg'"